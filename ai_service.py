...
def get_smart_proposal(prompt: str) -> dict | None:
    ...
    system_instruction = (
        "Ты — Главный инженер и проектировщик котельных.\n"
        "Твоя задача составить коммерческое предложение.\n"
        f"- Используй котел: {selected_boiler['model']} ({selected_boiler['power']} кВт) за {selected_boiler['price']} руб.\n"
        ...
        "Подумай, нужен ли бойлер косвенного нагрева, гидрострелка, коллектор, насосы теплых полов или радиаторов исходя из ТЗ.\n\n"
        "ВНИМАНИЕ! Верни СТРОГО валидный JSON. Соблюдай эту структуру:\n"
        "{\n"
        '  "internal_reasoning": "твой ход мыслей",\n'
        '  "title": "...",\n'
        '  "executive_summary": "...",\n'
        '  "mermaid_graph": "graph TD\\n A[Котел] --> B[Гидрострелка]\\n B --> C[Коллектор]\\n C --> D[Насос ТП]\\n C --> E[Насос Радиаторов]",\n'
